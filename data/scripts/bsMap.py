...
class HockeyStadium(Map):
    ...
    def __init__(self):
        ...
        bsGlobals.tint = (0.6, 0.8, 0.8)
        bsGlobals.ambientColor = (5,5,5)
        ...
        def snowfall():
                ...
                bs.emitBGDynamics(position=p,velocity=v,count=10,scale=0.3+random.random(),spread=0,chunkType='ice')
        self.isHockey = True
...
class BigGMap(Map):
    ...
    def onPreload(cls):
        ...
        data['modelBGTex'] = bs.getTexture('egg4')
        data['collideBG'] = bs.getCollideModel('natureBackgroundCollide')
...
class RoundaboutMap(Map):
    ...
    def onPreload(cls):
        ...
        data['modelBGTex'] = bs.getTexture('egg3')
        data['collideBG'] = bs.getCollideModel('natureBackgroundCollide')
        data['railingCollideModel'] = \
...
class MonkeyFaceMap(Map):
    ...
    def onPreload(cls):
        ...
        data['modelBGTex'] = bs.getTexture('egg1')
        data['collideBG'] = bs.getCollideModel('natureBackgroundCollide')
        data['railingCollideModel'] = \
...
class ZigZagMap(Map):
    ...
    def onPreload(cls):
        ...
        data['modelBGTex'] = bs.getTexture('egg2')
        data['collideBG'] = bs.getCollideModel('natureBackgroundCollide')
...
class ThePadMap(Map):
    ...
    def onPreload(cls):
        ...
        data['bgTex'] = bs.getTexture('bunnyColor')
...
class TowerDMap(Map):
    ...
    def onPreload(cls):
        ...
        data['bgTex'] = bs.getTexture('achievementFootballShutout')
        # fixme should chop this into vr/non-vr sections
        data['bgModel'] = bs.getModel('thePadBG')
...
class AlwaysLandMap(Map):
    ...
    def onPreload(cls):
        ...
        data['bgTex'] = bs.getTexture('impactBombColor')
...
class CourtyardMap(Map):
    ...
    def onPreload(cls):
        ...
        data['bgTex'] = bs.getTexture('landMineLit')
...
class RampageMap(Map):
    ...
    def onPreload(cls):
        ...
        data['bgTex'] = bs.getTexture('impactBombColorLit')
        data['bgTex2'] = bs.getTexture('impactBombColorLit')

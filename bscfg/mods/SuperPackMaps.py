...
NEW_MAP_DIRECTORY = 'superPackMapsData'  # The directory contains which were described in README
NEW_MAP_NAME = u'Super Pack Maps'  # ensure unicode
...
class InstallerLanguageSpanish(object):
    installing = u'Instalando Mapa [%s]...'
    success = u'Mapa [%s] instalación finalizada!'
    fail = u'Mapa [%s] instalación fallida'
    notSupported = u'Mapa [%s] no soportada en %s'

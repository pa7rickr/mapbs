...
class Portal(bs.Actor):
    def __init__(self,position1 = (0,1,0),position2 = (3,1,0),color = (random.random(),random.random(),random.random())):
        ...
        bsUtils.animate(self.visualRadius,"radius",{0:0})
        ...
        self.visualRadius2 = bs.newNode('shield',attrs={'position':self.position2,'color':color,'radius':2.1})
        bsUtils.animate(self.visualRadius2,"radius",{0:0})
        bsUtils.animateArray(self.node2,"scale",3,{0:(0,0,0),500:(self.radius*5,self.radius*5,self.radius*5)})
